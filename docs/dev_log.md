...
- Обновление: добавлена проверка единственного экземпляра через mutex, второй запуск завершает работу с сообщением.
- Обновление: приложение переведено в GUI-subsystem (wWinMain), консольное окно не появляется.
