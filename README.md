...
- Лог процессов: `YYYY-MM-DD.log` в папке `<root>\<PC_USER>\<YYYY-MM>\<YYYY-MM-DD>\`.

В лог процессов пишутся события появления и завершения процессов с временем работы.
